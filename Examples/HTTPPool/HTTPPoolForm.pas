...
type
  TMainForm = class(TForm)
    ...
    ConcurrentWorkersEdit: TSpinEdit;
    SpareWorkersEdit: TSpinEdit;
...
begin
  THTTPManager.RegisterSingletonOnDemandProc(
    procedure(Manager: TPoolManager)
    begin
      Manager.ConcurrentWorkersCount := Trunc(ConcurrentWorkersEdit.Value);
      Manager.SpareWorkersCount := Trunc(SpareWorkersEdit.Value);
